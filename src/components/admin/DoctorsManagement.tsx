...
const DoctorsManagement = () => {
  ...
  return (
    <>
        ...
        <CardContent>
          <div className="space-y-4">
            {doctors.map((doctor) => (
              <div
                key={doctor.id}
                className="flex items-center justify-between p-4 bg-muted/30 rounded-xl border border-muted/50"
              >
      ...
      />
      <EditDoctorDialog
        key={selectedDoctor?.id} //advanced react key prop optimization
