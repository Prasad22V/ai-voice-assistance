import { getUserAppoitmentStats } from "@/lib/action/appoitments";
...
const DentalHealthOverview = async () => {
  const appoitmentStats = await getUserAppoitmentStats();
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            <div className="text-2xl font-bold text-primary mb-1">
              {appoitmentStats.completedAppoitments}
            </div>
          ...
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            <div className="text-2xl font-bold text-primary mb-1">
              {appoitmentStats.totalAppoitments}
            </div>
            <div className="text-sm text-muted-foreground">
              Total Appointments
            </div>
          ...
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            <div className="text-2xl font-bold text-primary mb-1">
              {format(new Date(user?.createdAt!), "MMM yyyy") || "N/A"}
            </div>
