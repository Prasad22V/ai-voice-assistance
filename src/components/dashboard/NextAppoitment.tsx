import { getUserAppointments } from "@/lib/action/appoitments";
...
const NextAppoitment = async () => {
  const appoitments = await getUserAppointments();

  const upcomingAppointments =
    appoitments?.filter((appointment) => {
